...
# python experiment_domain_rand_PPOJax.py --config-name conf_4 > "$OUTPUT_FILE"
python experiment_domain_rand_continue_multiSeed_multipleInput2.py --config-name conf_4 > "$OUTPUT_FILE"
...
python experiment_domain_rand_continue_multiSeed_Curr.py --config-name conf_curr_newRew_5_multiSeed_2 checkpoint_path="$SAVE_PATH"
# python experiment_domain_rand_continue_Curr.py --config-name conf_curr_newRew_5_multiSeed_2 checkpoint_path="$SAVE_PATH"
