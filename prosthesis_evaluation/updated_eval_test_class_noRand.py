...
for i in range(n_steps):
    ...
    # print('grf_foot_l: ', grf_foot_l)
    # print('grf_foot_r: ', grf_foot_r)
    ...
    # print('grf_calc_l: ', grf_calcn_l)
    # print('grf_calc_r: ', grf_calcn_r)


    grf_l = grf_foot_l + grf_calcn_l
    grf_r = grf_foot_r + grf_calcn_r

    # grf_l, grf_r = prosthesis_metrics_handler.calc_mean_grf(env_state.data)
