...
checkpoint_base_path = args.ckpt_folder
for checkpoint_folder in sorted(os.listdir(checkpoint_base_path)):
    checkpoint_path = os.path.join(checkpoint_base_path, checkpoint_folder)
    ...
    output_path = os.path.join(os.path.dirname(checkpoint_base_path), f"{dt_str}__ckpt{checkpoint_number}_evaluation_{n_steps}steps.pkl")
