...
config.experiment.env_params["socket_ty_slack"] = False #True #False
config.experiment.env_params["socket_type"] = 'Test' #'Iceross Seal-In' #'Auto' #'Iceross Seal-In'
config.experiment.env_params["socket_ty_joint_stiffness"] = 50000#0 #40000 #20000 #2000 #70877 #40000 #70877
config.experiment.env_params["socket_ty_joint_damping"] = 5 #40 #20 #2 #6 #70 #7#0
config.experiment.env_params["socket_ty_joint_range"] = [-0.01,0.01] #[-0.015,-0.014] #[-0.01,0.01] #[-0.02,0.02] #[-0.008,0.01] #[-0.02,0.02] #[-0.008,0.01] #[-0.02,0.02] #
...
# config.experiment.env_params["socket_ty_slack"] = True
