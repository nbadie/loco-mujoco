...
python experiment_domain_rand.py --config-name conf_curr_ankle_1 > "$OUTPUT_FILE"
...
python experiment_domain_rand_continue_Curr.py --config-name conf_curr_ankle_2 checkpoint_path="$SAVE_PATH"
