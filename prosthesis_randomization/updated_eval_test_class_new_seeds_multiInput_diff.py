...
merged_train_state = from_state_dict(agent_state_2.train_state, merged_dict)

config = agent_conf_2.config
...
subfolder_name = 'multiInput_eval_pylon_socket_ori_x'
...
randomization_params_eval = {
    ...
    "randomize_prosthesis_body_orientation": True, #True,
...
def sample_actions_uncompiled(ts, obs, _rng):
    y, updates = agent_conf_2.network.apply({'params': ts.params, 'run_stats': ts.run_stats},
