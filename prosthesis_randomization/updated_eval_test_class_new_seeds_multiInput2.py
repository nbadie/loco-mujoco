...
subfolder_name = 'multiInput_199884800_eval_pylon_socket_ori_z_-5to5'
...
rng_seeds = jnp.array([jax.random.PRNGKey(i) for i in range(4,n_seeds)])
...
def run_evaluation_parallel(n_steps,n_seeds, env_states,merged_train_state,rng, save_dir, param_info=None):#subfolder, dt_init, param_info=None):
    ...
    for seed_idx in range(n_seeds-4):
