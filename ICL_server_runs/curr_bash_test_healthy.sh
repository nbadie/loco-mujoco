...
python experiment_domain_rand.py --config-name conf_healthy_1 > "$OUTPUT_FILE"
...
python experiment_domain_rand_continue_Curr.py --config-name conf_healthy_2 checkpoint_path="$SAVE_PATH"
