...
python experiment_domain_rand.py --config-name conf_curr_act_1 > "$OUTPUT_FILE"
...
# python experiment_domain_rand_fullCurr__.py --config-name conf_4_tt checkpoint_path="$SAVE_PATH"
python experiment_domain_rand_continue_wo_value_Curr.py --config-name conf_curr_act_2_woValue checkpoint_path="$SAVE_PATH"
