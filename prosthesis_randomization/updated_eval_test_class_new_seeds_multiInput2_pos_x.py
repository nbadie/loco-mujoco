...
subfolder_name = 'multiInput_199884800_eval_pylon_socket_pos_x'
...
randomization_params_eval = {
    ...
    "randomize_prosthesis_body_position": True, #True,
    ...
    "randomize_prosthesis_body_orientation": False, #True, #True,
